...
import com.gotocompany.depot.TestRecursiveMessageBQ;
...
public class ProtoFieldParserTest {
    ...
    public void shouldThrowExceptionIfNestedProtoNotFound() {
        Map<String, Descriptors.Descriptor> descriptorMap = new HashMap<String, Descriptors.Descriptor>() {{
            put("com.gotocompany.depot.TestMessageBQ", TestMessageBQ.getDescriptor());
        }};
    ...
    public void shouldParseProtoSchemaForNonNestedFields() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            put(".gotocompany.depot.TestMessageBQ.CurrentStateEntry", "com.gotocompany.depot.TestMessageBQ.CurrentStateEntry");
        ...
        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "com.gotocompany.depot.TestMessageBQ", descriptorMap, typeNameToPackageNameMap);
    ...
    public void shouldParseProtoSchemaForRecursiveFieldTillMaxLevel() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            put(".gotocompany.depot.TestRecursiveMessageBQ", "com.gotocompany.depot.TestRecursiveMessageBQ");
        }};

        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "com.gotocompany.depot.TestRecursiveMessageBQ", descriptorMap, typeNameToPackageNameMap);
    ...
    public void shouldParseProtoSchemaForNestedFields() {
        ...
        Map<String, String> typeNameToPackageNameMap = new HashMap<String, String>() {{
            ...
            put(".google.protobuf.Duration", "com.google.protobuf.Duration");
            put(".google.type.Date", "com.google.type.Date");
            put(".gotocompany.depot.TestMessageBQ", "com.gotocompany.depot.TestMessageBQ");
        }};

        ProtoField protoField = new ProtoField();
        protoField = protoMappingParser.parseFields(protoField, "com.gotocompany.depot.TestNestedMessageBQ", descriptorMap, typeNameToPackageNameMap);
    ...
    private void assertTestMessage(List<ProtoField> fields) {
        ...
        assertField(fields.get(16), "intervals", DescriptorProtos.FieldDescriptorProto.Type.TYPE_MESSAGE, DescriptorProtos.FieldDescriptorProto.Label.LABEL_REPEATED, 17);
        assertField(fields.get(17), "counter", DescriptorProtos.FieldDescriptorProto.Type.TYPE_INT32, DescriptorProtos.FieldDescriptorProto.Label.LABEL_OPTIONAL, 18);
        assertField(fields.get(18), "camelCase", DescriptorProtos.FieldDescriptorProto.Type.TYPE_STRING, DescriptorProtos.FieldDescriptorProto.Label.LABEL_OPTIONAL, 19);
