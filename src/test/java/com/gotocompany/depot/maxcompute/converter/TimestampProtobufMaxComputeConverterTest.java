...
public class TimestampProtobufMaxComputeConverterTest {
    ...
    public void shouldConvertPayloadToTimestampNtz() {
        ...
        Object result = timestampProtobufMaxComputeConverter.convertSingularPayload(new ProtoPayload(descriptor.getFields().get(3), message.getField(descriptor.getFields().get(3)), 0, TypeInfoFactory.TIMESTAMP));
    ...
    public void shouldConvertRepeatedTimestampPayloadToTimestampList() {
        ...
        Object result = timestampProtobufMaxComputeConverter.convertPayload(new ProtoPayload(repeatedDescriptor.getFields().get(3), message.getField(repeatedDescriptor.getFields().get(3)), 0, TypeInfoFactory.TIMESTAMP));
    ...
    public void shouldThrowInvalidMessageExceptionWhenDateIsOutOfMinValidRange() {
        ...
        timestampProtobufMaxComputeConverter.convertSingularPayload(new ProtoPayload(descriptor.getFields().get(3), message.getField(descriptor.getFields().get(3)), 0, TypeInfoFactory.TIMESTAMP));
    }
    ...
    public void shouldSkipDifferenceValidationWhenPartitionDisabled() {
        ...
        java.sql.Timestamp result = (java.sql.Timestamp) timestampProtobufMaxComputeConverter.convertSingularPayload(
                new ProtoPayload(descriptor.getFields().get(3), message.getField(descriptor.getFields().get(3)), 0, TypeInfoFactory.TIMESTAMP));
    ...
    public void shouldSkipDifferenceValidationWhenIsNotRootLevel() {
        ...
        java.sql.Timestamp result = (java.sql.Timestamp) timestampProtobufMaxComputeConverter.convertSingularPayload(new ProtoPayload(descriptor.getFields().get(3),
                message.getField(descriptor.getFields().get(3)), 1, TypeInfoFactory.TIMESTAMP));
