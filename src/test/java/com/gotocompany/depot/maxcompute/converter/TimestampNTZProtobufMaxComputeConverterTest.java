...
public class TimestampNTZProtobufMaxComputeConverterTest {
    ...
    public void shouldConvertRepeatedTimestampPayloadToTimestampList() {
        ...
        Object result = timestampNtzProtobufMaxComputeConverter.convertPayload(new ProtoPayload(repeatedDescriptor.getFields().get(3), message.getField(repeatedDescriptor.getFields().get(3)), 0, TypeInfoFactory.getArrayTypeInfo(TypeInfoFactory.TIMESTAMP_NTZ)));
    ...
    public void shouldThrowInvalidMessageExceptionWhenTimeDifferenceExceedsMaxPastDuration() {
        ...
        timestampNtzProtobufMaxComputeConverter.convertSingularPayload(new ProtoPayload(descriptor.getFields().get(3), message.getField(descriptor.getFields().get(3)), 0, TypeInfoFactory.TIMESTAMP_NTZ));
    }
    ...
    public void shouldSkipDifferenceValidationWhenPartitionDisabled() {
        ...
        LocalDateTime result = (LocalDateTime) timestampNtzProtobufMaxComputeConverter.convertSingularPayload(
                new ProtoPayload(descriptor.getFields().get(3), message.getField(descriptor.getFields().get(3)), 0, TypeInfoFactory.TIMESTAMP_NTZ));
    ...
    public void shouldSkipDifferenceValidationWhenIsNotRootLevel() {
        ...
        LocalDateTime result = (LocalDateTime) timestampNtzProtobufMaxComputeConverter.convertSingularPayload(new ProtoPayload(descriptor.getFields().get(3),
                message.getField(descriptor.getFields().get(3)), 1, TypeInfoFactory.TIMESTAMP_NTZ));
