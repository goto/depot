...
public class PrimitiveProtobufMaxComputeConverterTest {
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsByteArray() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(0), message.getField(descriptor.getFields().get(0)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsString() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(1), message.getField(descriptor.getFields().get(1)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsEnum() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(2), message.getField(descriptor.getFields().get(2)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsDouble() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(3), message.getField(descriptor.getFields().get(3)), true, 0));
    ...
    public void shouldThrowInvalidMessageExceptionWhenDoublePositiveInfinity() {
        ...
        primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(3), message.getField(descriptor.getFields().get(3)), true, 0));
    }
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsFloat() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(4), message.getField(descriptor.getFields().get(4)), true, 0));
    ...
    public void shouldThrowInvalidMessageExceptionWhenFloatPositiveInfinity() {
        ...
        primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(4), message.getField(descriptor.getFields().get(4)), true, 0));
    }
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsBoolean() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(5), message.getField(descriptor.getFields().get(5)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsInt64() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(6), message.getField(descriptor.getFields().get(6)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsUInt64() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(7), message.getField(descriptor.getFields().get(7)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsInt32() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(8), message.getField(descriptor.getFields().get(8)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsUInt32() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(9), message.getField(descriptor.getFields().get(9)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsFixed64() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(10), message.getField(descriptor.getFields().get(10)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsFixed32() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(11), message.getField(descriptor.getFields().get(11)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsSFixed32() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(12), message.getField(descriptor.getFields().get(12)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsSFixed64() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(13), message.getField(descriptor.getFields().get(13)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsSInt32() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(14), message.getField(descriptor.getFields().get(14)), true, 0));
    ...
    public void shouldReturnObjectAsItIsWhenTypeIsSInt64() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(15), message.getField(descriptor.getFields().get(15)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsByteArrayList() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(0), message.getField(descriptorRepeated.getFields().get(0)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsStringList() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(1), message.getField(descriptorRepeated.getFields().get(1)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsEnumList() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(2), message.getField(descriptorRepeated.getFields().get(2)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsDoubleList() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(3), message.getField(descriptorRepeated.getFields().get(3)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsFloatList() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(4), message.getField(descriptorRepeated.getFields().get(4)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsBooleanList() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(5), message.getField(descriptorRepeated.getFields().get(5)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsInt64List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(6), message.getField(descriptorRepeated.getFields().get(6)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsUInt64List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(7), message.getField(descriptorRepeated.getFields().get(7)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsInt32List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(8), message.getField(descriptorRepeated.getFields().get(8)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsUInt32List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(9), message.getField(descriptorRepeated.getFields().get(9)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsFixed64List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(10), message.getField(descriptorRepeated.getFields().get(10)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsFixed32List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(11), message.getField(descriptorRepeated.getFields().get(11)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsSFixed32List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(12), message.getField(descriptorRepeated.getFields().get(12)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsSFixed64List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(13), message.getField(descriptorRepeated.getFields().get(13)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsSInt32List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(14), message.getField(descriptorRepeated.getFields().get(14)), true, 0));
    ...
    public void shouldReturnListObjectAsItIsWhenTypeIsSInt64List() {
        ...
        Object result = primitiveProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptorRepeated.getFields().get(15), message.getField(descriptorRepeated.getFields().get(15)), true, 0));
