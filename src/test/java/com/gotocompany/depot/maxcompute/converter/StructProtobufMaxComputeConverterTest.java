...
public class StructProtobufMaxComputeConverterTest {
    ...
    public void shouldConvertStructPayloadToJsonString() {
        ...
        Object result = structProtobufMaxComputeConverter.convertPayload(new ProtoPayload(descriptor.getFields().get(4), message.getField(descriptor.getFields().get(4)), true, 0));
    ...
    public void shouldConvertRepeatedStructPayloadToJsonString() {
        ...
        Object result = structProtobufMaxComputeConverter.convertPayload(new ProtoPayload(repeatedDescriptor.getFields().get(4), message.getField(repeatedDescriptor.getFields().get(4)), true, 0));
